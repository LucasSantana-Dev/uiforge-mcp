...
- [ ] Wireframes or mockups available
...
- [ ] MCP protocol requirements identified
- [ ] Tool definitions planned
- [ ] Server lifecycle considerations
...
- [ ] **Critical**: Must be in next release
- [ ] **High**: Should be in next release
- [ ] **Medium**: Can wait for future release
...
- `needs-design` (if design required)
- `needs-discussion` (if more discussion needed)
...
- [ ] Schedule for planning discussion
- [ ] Create implementation epic (if large)

---

_This template is part of the UIForge shared GitHub patterns standardization._
