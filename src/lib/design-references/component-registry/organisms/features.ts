...
export const featureSnippets: IComponentSnippet[] = [
  {
    ...
    variant: 'grid',
    tags: ['features', 'benefits', 'grid', 'marketing'],
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    a11y: { roles: ['region'], ariaAttributes: ['aria-labelledby'], keyboardNav: 'N/A — content', contrastRatio: '4.5:1', focusVisible: false, reducedMotion: true },
    seo: { semanticElement: 'section', headingLevel: 'h2' },
    responsive: { strategy: 'mobile-first', breakpoints: ['sm', 'lg'] },
    quality: {
      antiGeneric: ['icon wrapper bg transitions on card hover', 'eyebrow text above heading', 'consistent card structure from atoms', 'hover:-translate-y-0.5 subtle lift', '6 features in 3-col grid for balanced layout'],
      inspirationSource: 'Stripe features section',
      craftDetails: ['max-w-5xl grid within max-w-7xl container', 'group hover on entire card', 'responsive: 1 → 2 → 3 columns'],
    },
  },
  {
    id: 'features-bento',
    ...
    type: 'feature-section',
    variant: 'bento',
    tags: ['features', 'bento', 'grid', 'asymmetric', 'marketing'],
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    responsive: { strategy: 'mobile-first', breakpoints: ['sm', 'lg'] },
    quality: {
      antiGeneric: ['asymmetric bento layout — not uniform grid', 'col-span-2 for featured items', 'rounded-2xl for premium feel', 'varied content lengths create natural rhythm'],
