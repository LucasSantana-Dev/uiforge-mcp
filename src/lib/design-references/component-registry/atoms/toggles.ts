...
export const toggleSnippets: IComponentSnippet[] = [
  {
    ...
    type: 'switch',
    variant: 'default',
    tags: ['toggle', 'boolean', 'settings', 'interactive'],
  ...
  >
    ...
    tailwindClasses: {
      ...
      switch: 'peer relative inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent bg-muted transition-colors duration-200 ease-[cubic-bezier(0.34,1.56,0.64,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary',
      thumb: 'pointer-events-none block h-4 w-4 rounded-full bg-background shadow-sm ring-0 transition-transform duration-200 ease-[cubic-bezier(0.34,1.56,0.64,1)] translate-x-0 data-[state=checked]:translate-x-4',
    },
    a11y: {
      roles: ['switch'],
    ...
    quality: {
      antiGeneric: ['spring easing cubic-bezier(0.34,1.56,0.64,1) for delight', 'role=switch for proper semantics', 'data-[state=checked] for framework-agnostic state'],
  ...
  },
  {
    ...
    type: 'checkbox',
    variant: 'default',
    tags: ['form', 'boolean', 'multi-select', 'interactive'],
    mood: ['professional', 'minimal'],
    industry: ['general', 'saas'],
  ...
  <span className="text-sm text-foreground leading-none">Accept terms and conditions</span>
    ...
    tailwindClasses: {
      ...
      checkbox: 'h-4 w-4 shrink-0 rounded border border-input bg-background text-primary ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 checked:bg-primary checked:border-primary',
  ...
  },
  {
    ...
    type: 'radio',
    variant: 'default',
    tags: ['form', 'single-select', 'options', 'interactive'],
    mood: ['professional', 'minimal'],
    industry: ['general', 'saas'],
  ...
  <label className="inline-flex items-center gap-2 cursor-pointer">
    ...
    tailwindClasses: {
      ...
      label: 'inline-flex items-center gap-2 cursor-pointer',
      radio: 'h-4 w-4 shrink-0 border border-input text-primary ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
    ...
    responsive: { strategy: 'mobile-first', breakpoints: [] },
    quality: {
      antiGeneric: ['fieldset + legend for proper grouping', 'arrow key navigation per WAI-ARIA', 'shared name attribute for mutual exclusion'],
